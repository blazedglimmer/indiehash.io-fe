        ...
        {videos.slice(0, 3).map((video, idx) => (
          ...
          >
            <div className="flex items-start gap-2 md:gap-4 mb-2 md:mb-4">
              <div className="w-6 h-6 md:w-10 md:h-10 rounded-full bg-gradient-to-r from-red-500 to-pink-500 flex items-center justify-center text-white font-bold text-xs md:text-base flex-shrink-0">
                {idx + 1}
              </div>
              <div className="flex-1 min-w-0">
                <h4 className="text-sm md:text-lg font-semibold text-white mb-1 md:mb-2 leading-tight">
                  {video?.title}
                </h4>
                ...
                <p className={`text-gray-300 text-xs md:text-sm mb-2 md:mb-4 leading-relaxed ${!expanded[idx] ? 'line-clamp-2 md:line-clamp-3' : ''}`}>
              ...
              <div className="flex items-center gap-1 flex-shrink-0">
                <button className="p-1.5 md:p-2 rounded-lg glass hover:bg-white/10 transition-colors">
